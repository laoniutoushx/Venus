 ...
 * 
 */
@WebServiceClient(name = "UserService", targetNamespace = "http://sos.haruhi.ws/test/", wsdlLocation = "http://localhost:8080/ws?wsdl")
    ...
    extends Service
{
    ...
    private final static QName USERSERVICE_QNAME = new QName("http://sos.haruhi.ws/test/", "UserService");
    ...
    public IUserService getUserServicePort() {
        return super.getPort(new QName("http://sos.haruhi.ws/test/", "UserServicePort"), IUserService.class);
    }
    ...
    public IUserService getUserServicePort(WebServiceFeature... features) {
        return super.getPort(new QName("http://sos.haruhi.ws/test/", "UserServicePort"), IUserService.class, features);
    }
