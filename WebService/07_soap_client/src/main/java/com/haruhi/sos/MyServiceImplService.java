 ...
 * 
 */
@WebServiceClient(name = "MyServiceImplService", targetNamespace = "http://haruhi.com/", wsdlLocation = "http://localhost:8888/ws?wsdl")
@HandlerChain(file = "handler-chain.xml")       // 配置 SOAPHandler 执行
    ...
    extends Service
{
    ...
    private final static QName MYSERVICEIMPLSERVICE_QNAME = new QName("http://haruhi.com/", "MyServiceImplService");
    ...
    public IMyService getMyServiceImplPort() {
        return super.getPort(new QName("http://haruhi.com/", "MyServiceImplPort"), IMyService.class);
    }
    ...
    public IMyService getMyServiceImplPort(WebServiceFeature... features) {
        return super.getPort(new QName("http://haruhi.com/", "MyServiceImplPort"), IMyService.class, features);
    }
