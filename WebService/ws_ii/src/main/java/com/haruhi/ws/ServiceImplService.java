 ...
 * 
 */
@WebServiceClient(name = "ServiceImplService", targetNamespace = "http://ws.haruhi.com/", wsdlLocation = "http://localhost:8888/ws?wsdl")
    ...
    extends Service
{
    ...
    private final static QName SERVICEIMPLSERVICE_QNAME = new QName("http://ws.haruhi.com/", "ServiceImplService");
    ...
    public IService getServiceImplPort() {
        return super.getPort(new QName("http://ws.haruhi.com/", "ServiceImplPort"), IService.class);
    }
    ...
    public IService getServiceImplPort(WebServiceFeature... features) {
        return super.getPort(new QName("http://ws.haruhi.com/", "ServiceImplPort"), IService.class, features);
    }
