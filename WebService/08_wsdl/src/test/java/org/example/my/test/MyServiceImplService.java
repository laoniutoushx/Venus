 ...
 * 
 */
@WebServiceClient(name = "MyServiceImplService", targetNamespace = "http://www.example.org/my/", wsdlLocation = "http://localhost:7777/ms?wsdl")
    ...
    extends Service
{
    ...
    private final static QName MYSERVICEIMPLSERVICE_QNAME = new QName("http://www.example.org/my/", "MyServiceImplService");

    static {
        URL url = null;
        WebServiceException e = null;
        try {
            url = new URL("http://localhost:7777/ms?wsdl");
    ...
    public IMyservice getMyServiceImplPort() {
        return super.getPort(new QName("http://www.example.org/my/", "MyServiceImplPort"), IMyservice.class);
    }
    ...
    public IMyservice getMyServiceImplPort(WebServiceFeature... features) {
        return super.getPort(new QName("http://www.example.org/my/", "MyServiceImplPort"), IMyservice.class, features);
    }
