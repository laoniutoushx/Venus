 ...
 */
@WebServlet(urlPatterns = "/QRCode_Alipay_MinSheng")
public class MinSheng2AlipayQRCodeDoPayServlet extends HttpServlet {
    @Override
    ...
    protected void doPost(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
        ...
        obj.put("notifyUrl", MinShengConfig.test_Alipay_Notify_Url);   // 异步通知
