...
public abstract class AbstractNAV {
    public static Map<String, Integer> readTicker() throws IOException {
        final BufferedReader reader = new BufferedReader(
                new FileReader("s:/stocks.txt")
        );
    ...
    public void timeAndComputeValue() throws ExecutionException, InterruptedException,
            IOException {
        final long start = System.nanoTime();
        final Map<String, Integer> stocks =readTicker();
    ...
    public abstract double computeNetAssetValue(
        final Map<String, Integer> stocks) throws ExecutionException,
