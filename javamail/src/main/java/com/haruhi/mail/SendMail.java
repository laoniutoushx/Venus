...
/**
 * @Project <h2>Venus</h2>
 * @Package <h3>com.haruhi.mail</h3>
 * @Description <p></p>
 * @Author SuzumiyaHaruhi
 * @Time 2017/12/25 10:21:46
 * @Version v1.0
 */
public class SendMail {
    public static void main(String[] args) throws Exception {
        ...
        *//*
        ...
        //    真正要发送时, 邮箱必须是真实有效的邮箱。
        message.setFrom(new InternetAddress("shanghaoxi@sina.com", "USER_AA", "UTF-8"));

        // 3. To: 收件人
        message.setRecipient(MimeMessage.RecipientType.TO, new InternetAddress("578585118@qq.com", "USER_CC", "UTF-8"));
        //    To: 增加收件人（可选）
